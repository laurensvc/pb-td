...
export function waveClearGoldBonus(waveNumber) {
    return 8 + Math.floor(waveNumber * 1.5);
}
export function getWaveCount() {
    return TOTAL_WAVES;
}
export function getWave(areaId, tierId, waveIndex) {
...
function buildWave(areaId, waveNumber, tier) {
...
function composeWaveSegments(waveNumber, isBoss, tier) {
    if (isBoss) {
