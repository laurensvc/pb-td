...
describe('tickTowerCombat', () => {
    ...
    it('closest_to_goal prefers creep farther along path', () => {
        ...
        const result = tickTowerCombat(content, [tower], new Map(), [near, far], new Map(), 1, { matrix: content.armorDamageMatrix, rng }, null);
    ...
    it('hold fire prevents attacks', () => {
        ...
        const held = { ...tower, holdFire: true };
        const result = tickTowerCombat(content, [held], new Map(), [creep], new Map(), 1, { matrix: content.armorDamageMatrix, rng }, null);
    ...
    it('highest_hp targets the tankiest creep', () => {
        ...
        const hpTower = { ...tower, targetingMode: 'highest_hp' };
        const result = tickTowerCombat(content, [hpTower], new Map(), [weak, tank], new Map(), 1, { matrix: content.armorDamageMatrix, rng }, null);
        const fired = result.events.find((e) => e.type === 'tower_fired');
