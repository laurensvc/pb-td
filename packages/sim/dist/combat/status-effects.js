...
export function effectiveSlowPercent(creep) {
    if (creep.slowImmune || creep.slowEffects.length === 0)
        return 0;
...
export function pruneExpiredEffects(effects, dt) {
