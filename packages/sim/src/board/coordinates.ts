...
export function gridToWorldCenter(gx: number, gy: number): WorldCoord {
  return {
...
export function gridToWorldTopLeft(gx: number, gy: number): WorldCoord {
...
export function snapFootprint(gx: number, gy: number): GridCoord {
  return {
