...
export type CombatEvent =
  | { type: 'creep_spawned'; creepId: string; enemyId: string; waveNumber: number }
  | { type: 'creep_killed'; creepId: string; killerTowerId: string; gold: number }
  | { type: 'creep_leaked'; creepId: string; waveNumber: number; lifeCost: number }
  | { type: 'attack_missed'; creepId: string; towerId: string }
  | { type: 'tower_fired'; towerId: string; creepId: string; damage: number }
  | { type: 'wave_spawn_complete'; waveNumber: number }
  | { type: 'wave_cleared'; waveNumber: number }
  | { type: 'mvp_awarded'; towerId: string; stacks: number }
