...
describe('resolveDamage', () => {
  ...
  it('applies armor type matrix for pierce vs heavy', () => {
    ...
    const result = resolveDamage(
      creep,
      { baseDamage: 100, attackType: 'pierce', sourceTowerId: 't1' },
  ...
  it('blocks magic damage when magic immune', () => {
    ...
    const result = resolveDamage(
      creep,
      { baseDamage: 50, attackType: 'magic', sourceTowerId: 't1' },
      { matrix: armorDamageMatrix, rng },
    )
  ...
  it('can miss via evasion', () => {
    ...
    const result = resolveDamage(
      creep,
      { baseDamage: 50, attackType: 'normal', sourceTowerId: 't1' },
      { matrix: armorDamageMatrix, rng },
    )
  ...
  it('pure damage ignores armor typing', () => {
    ...
    const result = resolveDamage(
      creep,
      { baseDamage: 40, attackType: 'pure', sourceTowerId: 't1' },
      { matrix: armorDamageMatrix, rng },
    )
