...
import type { GridRect } from '../schemas/common.js'

const MAP_WIDTH = 148
const MAP_HEIGHT = 148
const BORDER = 2

function borderRects(): GridRect[] {
  return [
...
function goalApproachLane(): GridRect[] {
  return [
...
function landmarkPads(): GridRect[] {
...
export const crownfallGrassBoard: BoardDefinition = {
  id: 'crownfall-grass',
...
export function landmarkPadRects(board: BoardDefinition): GridRect[] {
