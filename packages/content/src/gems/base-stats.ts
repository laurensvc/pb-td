...
export const gemTypeTemplates: Record<GemType, GemTypeTemplate> = {
  amethyst: {
    type: 'amethyst',
...
export const gemTypes = Object.keys(gemTypeTemplates) as GemType[]

export const v1Qualities = ['chipped', 'flawed', 'normal'] as const
